...
<a href="ratings.php"><button>ADD NEW</button></a>
...
<td><a onclick ="return confirm('Are you sure....')"; href="delete_ratings.php?id=<?php echo $row['rating_id'];?>"><img src="hr.gif"></a></tgd>
<td><a href="edit_ratings.php?id=<?php echo $row['rating_id'];?>"><img src="edit-icon.gif"></a></td>
</tr>
<?php
}
?>
