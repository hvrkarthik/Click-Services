...
<a href="customer.php"><button>ADD NEW</button></a>
...
<td><a onclick ="return confirm('Are you sure....')"; href="delete_customer.php?id=<?php echo $row['customer_id'];?>"><img src="hr.gif"></a></td>
