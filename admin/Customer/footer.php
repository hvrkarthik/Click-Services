    <!-- Footer -->
            <footer>
                <div class="pull-right">
                    Design & Developed by <strong><a href="http://www.vwingsgroup.com" target="_blank">KAPsLOCK</a></strong>
                </div>
                <div class="pull-left">
                    <span id="year-copy"></span> &copy; <strong><a href="http://www.vwingsgroup.com" target="_blank">KAPsLOCK</a></strong>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
